...
| 重要度 | 基準 | リリース判断 |
|---|---|---|
| P0 | データ破壊、重大なセキュリティ/プライバシー問題、全端末で起動不能、重大な法令・ストアポリシー違反 | 即時公開停止 |
...
- Screen recording: （記入）
- Console/log: （記入）
- Play Console/App Store Connect: （記入）
- Network capture/privacy report: （記入）
- Related PR/Issue: （記入）
