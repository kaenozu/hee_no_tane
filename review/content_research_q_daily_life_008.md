...
- 選択肢:
  ...
  4. `注意・警告`
- 正答: `非常口・避難経路や応急手当`
- 解説: `HSEのL64表1は、緑を非常脱出・応急手当の標識に割り当て、扉、出口、避難経路、設備、施設を示すとしている。赤い炎の補色だからという旧本文の因果説明は削除した。`

## 最終カード

- タイトル: `安全標識の緑色`
- shortText: `非常口・避難経路と応急手当を示す色。`
- detailText: `英国HSEの安全標識ガイダンスL64表1では、緑色は非常脱出・応急手当の標識に使われ、扉、出口、避難経路、設備、施設を示す。炎との補色関係を一般理由としては説明していない。`
